...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_LGUI,        LSFT_T(KC_A),   LCTL_T(KC_O),   LALT_T(KC_E),   KC_U,           LT(2,KC_I),     TT(3),                                                                          ES_SLSH,        RSFT_T(KC_D),   KC_R,           KC_T,           KC_N,           KC_S,           ES_UNDS,        
    ES_DQUO,        ES_LESS,        KC_Q,           KC_J,           KC_K,           KC_X,                                           KC_B,           KC_M,           KC_W,           KC_V,           KC_Z,           ES_ACUT,        
    MO(4),          KC_HOME,        KC_PGDOWN,      KC_PGUP,        KC_END,         RALT_T(KC_APPLICATION),                                                                                                LCTL_T(KC_ESCAPE),KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       ES_MINS,        
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                 ES_BSLS,        ES_QUES,        ES_LPRN,        ES_RPRN,        ES_AMPR,        ES_PIPE,        KC_TRANSPARENT, 
