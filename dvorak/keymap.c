...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ES_BSLS,        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           TD(DANCE_0),                                    TD(DANCE_2),    KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           ES_PLUS,        
    ES_DQUO,        KC_DOT,         KC_COMMA,       ES_NTIL,        KC_P,           KC_Y,           TD(DANCE_1),                                    TD(DANCE_3),    KC_F,           KC_G,           KC_C,           KC_H,           KC_L,           ES_GRV,         
    KC_LGUI,        LSFT_T(KC_A),   LCTL_T(KC_O),   LALT_T(KC_E),   KC_U,           KC_I,           TT(2),                                                                          TD(DANCE_4),    RSFT_T(KC_D),   KC_R,           KC_T,           KC_N,           KC_S,           ES_MINS,        
    ...
    KC_SPACE,       KC_BSPACE,      KC_DELETE,                      TD(DANCE_5),    KC_TAB,         KC_ENTER
  ),
  [1] = LAYOUT_moonlander(
...
void dance_0_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        case SINGLE_TAP: register_code16(RALT(KC_2)); break;
        case SINGLE_HOLD: register_code16(RALT(KC_4)); break;
        case DOUBLE_TAP: register_code16(RALT(KC_2)); register_code16(RALT(KC_2)); break;
        case DOUBLE_SINGLE_TAP: tap_code16(RALT(KC_2)); register_code16(RALT(KC_2));
    }
}
...
void dance_0_reset(qk_tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[0].step) {
        case SINGLE_TAP: unregister_code16(RALT(KC_2)); break;
        case SINGLE_HOLD: unregister_code16(RALT(KC_4)); break;
        case DOUBLE_TAP: unregister_code16(RALT(KC_2)); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(RALT(KC_2)); break;
    }
