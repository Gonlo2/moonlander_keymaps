...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ES_OVRR,        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           TD(DANCE_0),                                    ES_CCED,        KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           ES_PLUS,        
    ES_DQUO,        KC_DOT,         KC_COMMA,       ES_NTIL,        KC_P,           KC_Y,           LCTL(KC_W),                                     ES_ACUT,        KC_F,           KC_G,           KC_C,           KC_H,           KC_L,           ES_GRV,         
    KC_LGUI,        LSFT_T(KC_A),   LCTL_T(KC_O),   LALT_T(KC_E),   KC_TMUX_U,      KC_I,           TT(2),                                                                          TD(DANCE_1),    RSFT_T(KC_D),   KC_R,           KC_T,           KC_N,           KC_S,           ES_MINS,        
    ...
    KC_SPACE,       KC_BSPACE,      KC_DELETE,                      TD(DANCE_2),    KC_TAB,         KC_ENTER
  ),
  [1] = LAYOUT_moonlander(
